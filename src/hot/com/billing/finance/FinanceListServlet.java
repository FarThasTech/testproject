...
public class FinanceListServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try{
			...
			FinanceVOListDTO dataTableObject = new FinanceVOListDTO();
			...
			financeBean.financeVO = new FinanceVO();
			financeBean.activeUser = activeUser;
			financeBean.localeSelector = localeSelector;
			financeBean.entityManager = entityManager;
			List<FinanceVO> financeList = financeBean.getList("Finance", startDate, endDate);
			List<FinanceVO> financeListVO = new ArrayList<FinanceVO>();
			...
			for(FinanceVO finVO: financeList) {
				...
				Date transactionDate = finVO.getTransactionDate();
				String transDate = DateUtil.getDateToStringFormat(transactionDate, datePattern);
				...
				financeVO.setTransDate(transDate != null && !transDate.isEmpty() ? transDate : "");
